...
// //       products: [{ product: item.product._id, quantity: item.quantity }],
...
//     // Prepare order products with seller info
...
//     // Create a single order (all products together)
//     const order = await Order.create({
//       buyer: req.user._id,
...
//   try {
//     // Orders where seller is in products array
