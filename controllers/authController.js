...
//     const hashedPassword = await bcrypt.hash(password, 10);
//     const user = await User.create({ name, email: email.toLowerCase(), password: hashedPassword, role: "buyer" });
...
//     // 1️⃣ Print the raw email from the request
//     console.log("Email received from client:", JSON.stringify(email));

//     // 2️⃣ Print current DB info
//     console.log("Connected DB host:", req.app.get("dbHost") || "unknown");
//     console.log("Connected DB name:", req.app.get("dbName") || "unknown");
